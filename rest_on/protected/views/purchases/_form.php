        ...
        <div class="panel panel-default height">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php echo CHtml::button('Pagada', array('id' => 'saveComp', 'class' => 'btn btn-block btn-primary btn-lg', 'disabled' => ($empresa == 0) ? 'disabled' : '')); ?>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="input-group">
                            ...
                            $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                                ...
                                'htmlOptions' => array(
                                    ...
                                    'value' => ($model->purchase_date) ? $model->purchase_date : date('Y-m-d'),
                                ),
                            ));
                            ?>
                        </div>

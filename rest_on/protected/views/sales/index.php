    ...
    <div class="col-xs-12">
      <div class="col-xs-6">
        <div class="box box-warning">
          <div class="box-header">
            <h3 class="box-title">Ventas <small>Pendientes</small></h3>
          </div>  
          <div class="box-body">
            	...
            	<div id="Sales_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            		...
            		<div class="row">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'filter' => $model,
                            'columns' => array(
                                array('name' => 'sale_id', 'htmlOptions' => array('style' => 'width: 60px !important;')),
                                array(
                                    'name' => 'request_id',
      ...
      <div class="col-xs-6">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">Ventas <small>Aprobadas</small></h3>
          </div>  
          <div class="box-body">
      ...
      <div class="col-xs-12">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Ventas <small>Anuladas</small></h3>
          </div>  
          <div class="box-body">

...
$this->menu=array(
	...
	array('label'=>'Crear Components', 'url'=>array('create'), 'visible'=>$visible),
	array('label'=>'Detalle Components', 'url'=>array('view', 'id'=>$model->component_id)),
		...
		<div class="col-xs-12">
			<div class="box box-danger">
				<div class="box-header">
	              <h3 class="box-title">Components <small>Actualizar Components</small></h3>
	            </div>
	            <div class="box-body">

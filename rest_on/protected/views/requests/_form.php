    ...
    <div class="col-xs-12 col-md-12 col-lg-12 pull-left" id="movimientos">
        <div class="panel panel-default height">
            ...
            <div class="panel-body">
                <div class="alert alert-danger" id="div-errores-store" style="display: none;">Por favor diligencie todos los datos en rojo y guarde.</div>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <table class="table table-condensed">
                                <tbody> 
                                    ...
                                    <tr>                                                
                                        ...
                                        <?php echo $form->hiddenField($model, 'request_total', array('class' => 'form-control')); ?>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <?php echo $form->hiddenField($model, 'request_net_worth', array('class' => 'form-control')); ?>
                                    </tr>
                                    <tr>
                ...
                <div class="row">
                    <div class="col-md-12">                                
                        <div class="input-group">
                            ...
                            <input class="form-control" value="Pedido por email" type="text" readonly="readonly">    
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <?php echo CHtml::button('Aprobado', array('id' => 'saveComp', 'class' => 'btn btn-block btn-primary btn-lg')); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xs-12 col-md-4 col-lg-4 datos-generales" style="display: none;" id="datos-generales">
        <div class="panel panel-default height">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <label><?php echo $form->labelEx($model, 'request_date'); ?></label>
                        <div class="input-group">
                            <div class="input-group-addon">
                            ...
                            $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                                ...
                                'htmlOptions' => array(
                                    ...
                                    'value' => ($model->request_date) ? $model->request_date : date('Y-m-d'),
                                ),
                            ));
                            ?>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            ?>
                            <?php echo $form->hiddenField($model, 'request_status', array('class' => 'form-control status', 'value' => '1')); ?>
                        </div>
                    </div>                            
                </div>
                <br>
                ...
                <div class="row">                           
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            echo $form->dropDownList($model, 'accounts_id', $account, array('class' => 'form-control', 'prompt' => '--Seleccione--', 'options' => array($datos['RequestConfig']->accounts_id => array('selected' => true))));
                            ?>   
                        </div>
                    </div>                          
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label><?php echo $form->labelEx($model, 'request_remarks'); ?></label>                                
                        <div class="input-group">
                            <div class="input-group-addon">
                                <i class="fa fa-sticky-note-o"></i>
                            </div>
                            <?php echo $form->textArea($model, 'request_remarks', array('size' => 60, 'maxlength' => 500, 'class' => 'form-control')); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function pasar(id, e) {
        console.log(e)
        var accion = $(e).attr('class');
        var padre = $(e).siblings('input#padre').val();
        if (accion == 'add-true') {
            $('.div-prod-' + id + '-' + padre).appendTo('#lista_final');
            $(e).html('<b style="color:red">Eliminar</b>');
            $(e).removeClass('add-true');
            $(e).addClass('add-false');
        }
        if (accion == 'add-false') {
            $('.div-prod-' + id + '-' + padre).appendTo('#padre-' + padre);
            $(e).html('<b >Seleccionar</b>');
            $(e).removeClass('add-false');
            $(e).addClass('add-true');
        }
    }
...
<script>
    jQuery(function ($) {
        ...
        $('#tablaproductos-store').on('click', '.component', function () {            
            var comId = this.id.split('component-');
            console.log(comId[1]);         
            var $table = $('#tablaproductos tbody'),
                    components = new searchComp(this),
            ...
            productComp = "component_"+comId[1];            
            ...
            function validateComponents(e) {
                ...
                if (!error) {
                    ...
                    console.log('Object: '+productComp);
                    console.log(JSON.stringify(components));

                    $("#"+productComp).val(JSON.stringify(components));
            ...
            $saveBtn.off('click', validateComponents);
        ...
        function searchComp(e) {
            return $.parseJSON($(e).children('input').val());
        }
    ...
    function bruto() {
        ...
        $('#Requests_request_total').val(bruto);
        ...
        $('#Requests_request_net_worth').val(granTotal);
    }
    function customer() {
        var id = $("#Requests_customer_nit").val();
        if (id) {
            $.ajax({
                method: "POST",
    ...
    $('#saveComp').click(function () {
        $('#Requests_request_status').val(1);
        guardar();
    });
    $('#savePen').click(function () {
        $('#Requests_request_status').val(0);
        guardar();
    });
    function guardar() {
        var next_inc = Number($("#num_registros").val());
        ...
        var date = $('#Requests_request_date').val();
        if (!date) {
            $('#Requests_request_date').addClass("error-comp");
            error++;
        } else {
            $('#Requests_request_date').removeClass("error-comp");
        }
        var supp = $('#Requests_customer_nit').val();
        if (!supp) {
            $('#Requests_customer_nit').addClass("error-comp");
            error++;
        } else {
            $('#Requests_customer_nit').removeClass("error-comp");
        }
        if (error > 0 || real < 1) {
            var dato = new Array()

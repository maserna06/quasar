...
$this->menu = array(
    ...
    array('label' => 'Actualizar Pedido', 'url' => array('update', 'id' => $model->request_id)),
                            ...
                            <div class="panel panel-default height">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <?php echo CHtml::button('Aprobado', array('id' => 'saveComp', 'class' => 'btn btn-block btn-success btn-lg')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                ?>
                                                <?php echo $form->hiddenField($model, 'request_status', array('class' => 'form-control', 'value' => '1')); ?>
                                            </div>
                                        </div>                            
                                    </div>
                                    <br>

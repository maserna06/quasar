...
$this->menu=array(
	...
	array('label'=>'Actualizar Conversion de Unidad', 'url'=>array('update', 'id'=>$model->convertion_id)),
  ...
  <div class="row">
    <div class="col-xs-12">
      <h2 class="page-header">
        <i class="fa fa-file-text"></i> Detalle de Conversion de Unidad 
    ...
    Yii::app()->clientScript->registerScript("export", "
        $('#export_pdf').click(function(){
            if(confirm('" . Yii::t('application', 'Generation time can take up to 5 minutes, depending on the number of records. Want to continue?') . "')){
                window.open('" . Yii::app()->controller->createUrl('exportPdf', array('type' => 'PDF', 'id' => $model->convertion_id)) . "', '', 'hotkeys=no, height=500, width=700');
            }
            return false;
        });

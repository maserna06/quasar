...
$this->menu = array(
    ...
    array('label' => 'Actualizar Remision', 'url' => array('update', 'id' => $model->referralP_id)),
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12 pull-left" id="movimientos">
                            <div class="panel panel-default height">
                                ...
                                <div class="panel-body">
                                                ...
                                                <table class="table table-condensed">
                                                    <tbody> 
                                                        ...
                                                        <tr>                                                
                                                            ...
                                                            <?php echo $form->hiddenField($model, 'referralP_total', array('class' => 'form-control')); ?>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php echo $form->hiddenField($model, 'referralP_net_worth', array('class' => 'form-control')); ?>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <?php if ($datos['referralPConfig']->referralP_payment == 1) { ?>
                                        <br>
                                        <div class="row">
                                            <div class="col-md-9">                                
                                                <div class="input-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label><?php echo $form->labelEx($model, 'referralP_remarks'); ?></label>                                
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-sticky-note-o"></i>
                                                </div>
                                                <?php echo $form->textArea($model, 'referralP_remarks', array('size' => 60, 'maxlength' => 500, 'class' => 'form-control remarks')); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <br>                        
                        ...
                        <div class="col-xs-12 col-md-4 col-lg-4 " style="display: none;" id="datos-generales">
                            <div class="panel panel-default height">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label><?php echo $form->labelEx($model, 'referralP_date'); ?></label>
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                ?>
                                                <?php echo $form->hiddenField($model, 'referralP_status', array('class' => 'form-control status', 'value' => '1')); ?>
                                            </div>
                                        </div>                            
                                    </div>
                                    <br>
                                    <div class="row">                           
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php
                                                echo $form->dropDownList($model, 'customer_nit', SuppliersExtend::supplierCompany(), array('class' => 'form-control', 'prompt' => '--Seleccione--'));
                                                ?> 
                                            </div>
                                        </div>                          
                                    </div>
                                    ...
                                    <div class="row">                           
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                echo $form->dropDownList($model, 'accounts_id', $account, array('class' => 'form-control account', 'options' => array($datos['referralPConfig']->accounts_id => array('selected' => true))));
                                                ?>  
                                            </div>
                                        </div>                          
                                    </div>
...
<script>
    ...
    $('.medios-pago').click(function () {
        ...
        $("#bodyArchivos").html('');
        $.ajax({
            url: "<?php echo $this->createUrl('/wharehouses/modalConfig') ?>",
            success: function (result) {
                $("#bodyArchivos").html(result);                
                $("#myModal").modal({keyboard: false});
                $(".modal-dialog").width("40%");
                $(".modal-title").html("Medios de Pago");
                $(".modal-footer").html('<div class="col-md-12"><div class="row"><div class="col-md-6"><div class="form-group"><input class="btn btn-block btn-success btn-lg" type="submit" name="yt1" value="Pagar"></div></div><div class="col-md-6"><div class="form-group"><input class="btn btn-block btn-danger btn-lg" data-dismiss="modal" id="exit" type="submit" name="yt2" value="Cancelar"></div></div></div></div>');
            }
        });
    });
    ...
    function detalle(myArr) {
        ...
        var id = $("#ReferralsP_customer_nit").val();
        customer(id);
    }
    ...
    function detalleReferral(myArr) {
        ...
        for (i = 0; i < myArr.length; i++) {
            ...
            container.appendChild(tr);
            var iden = 'trprod' + next_inc;
            $('#' + iden).load("<?= Yii::app()->baseUrl ?>/referralsP/detailView?id_detail=" + myArr[i] + '&cantidad=' + next_inc, function (response, status, xhr) {
                if (response == '') {
                    container.removeChild(tr);
                    next_inc = next_inc - 1;
                    real = real - 1;
...
<script>
    jQuery(function ($) {
        ...
        if (status == 2) {
            $('#referralsP-form').find('input, textarea, button, select').attr('disabled', 'disabled');
            $('#referralsP-form').find('a').removeAttr("onclick");
        }
        ...
        $('#tablaproductos').on('click', '.component', function () {
...
//            validateComponents(true);
         ...
         * Cargar pedidos
         */
        $("#ReferralsP_request_id").change(function () {
            limpiar();
            var id = $("#ReferralsP_request_id").val();
            if (id > 0) {
                $.ajax({
                    method: "POST",
                    ...
                    success: function (result) {
                        ...
                        $('#ReferralsP_accounts_id').val(datos['cuenta']);
                        $('#ReferralsP_customer_nit').val(datos['proveedor']);
                        $('#ReferralsP_referralP_remarks').val(datos['obs']);
                        customer(datos['proveedor']);
                    }
        ...
        function limpiar() {
            ...
            $("#num_registros").val(0);
            $("#num_real").val(0);
            $("#ReferralsP_referralP_remarks").val('');
            $("#ReferralsP_customer_nit").val('');
            $("#taxCustom").val(0);
            $("#disCustom").val(0);
            $('#valorBruto').html('$ 0');
            $('#valorImp').html('$ 0');
    ...
    function bruto() {
        ...
        $('#ReferralsP_referralP_total').val(bruto);
        ...
        $('#ReferralsP_referralP_net_worth').val(granTotal);
    }
    function customer() {
        var id = $('#ReferralsP_customer_nit').val();
        if (id) {
    ...
    $('#saveComp').click(function () {
        $('#ReferralsP_referralP_status').val(1);
        guardar();
    });
    $('#savePen').click(function () {
        $('#ReferralsP_referralP_status').val(0);
        guardar();
    });
    function guardar() {
        var next_inc = Number($("#num_registros").val());
        ...
        var date = $('#ReferralsP_referralP_date').val();
        if (!date) {
            $('#ReferralsP_referralP_date').addClass("error-comp");
            error++;
        } else {
            $('#ReferralsP_referralP_date').removeClass("error-comp");
        }
        var supp = $('#ReferralsP_customer_nit').val();
        if (!supp) {
            $('#ReferralsP_customer_nit').addClass("error-comp");
            error++;
        } else {
            $('#ReferralsP_customer_nit').removeClass("error-comp");
        }
        if (error > 0 || real < 1) {
            var dato = new Array();

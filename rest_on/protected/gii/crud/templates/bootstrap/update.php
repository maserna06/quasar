...
$this->menu=array(
	...
	array('label'=>'Detalle <?php echo $this->modelClass; ?>', 'url'=>array('view', 'id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>)),
		...
		<div class="col-xs-12">
			<div class="box box-danger">
				<div class="box-header">
	              <h3 class="box-title"><?php echo $this->getModelClass(); ?> <small>Actualizar <?php echo $this->getModelClass(); ?></small></h3>
	            </div>
	            <div class="box-body">

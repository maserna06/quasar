...
class CitiesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Cities']))
		{
			...
			if($model->save())
				$datosConf = array('estado' => 'success', 'mensaje' => 'Ciudad creada correctamente.');
			else
                $datosConf = array('estado' => 'danger', 'mensaje' => 'Datos de Ciudad vacios; campos marcados con ( * ) son obligatorios.');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Cities']))
		{
			$model->attributes=$_POST['Cities'];
			if($model->save())
				$datosConf = array('estado' => 'success', 'mensaje' => 'Ciudad actualizada correctamente.');
			else
                $datosConf = array('estado' => 'danger', 'mensaje' => 'Datos de Ciudad vacios; campos marcados con ( * ) son obligatorios.');

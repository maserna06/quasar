 ...
 */
class RequestConfig extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('request_id, request_format, accounts_id, wharehouse_id', 'required', 'on'=>'insert,update'),
			array('request_id, request_format, wharehouse_id', 'required', 'on'=>'company'),
	 ...
	 * @return RequestConfig the static model class
	 */

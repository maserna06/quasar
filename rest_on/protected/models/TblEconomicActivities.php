 ...
 */
class TblEconomicActivities extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'economic_activity_description' => 'Economic Activity Description',
			'economic_activity_status' => 'Economic Activity Status',
		);
	}
	 ...
	 * @return TblEconomicActivities the static model class
	 */

 ...
 * @property double $purchase_details_discount
 ...
 */
class TblPurchaseDetails extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('purchase_id, product_id, wharehouse_id, purchase_details_price, purchase_details_discount, purchase_details_quantity', 'required'),
			array('purchase_id, product_id, wharehouse_id', 'numerical', 'integerOnly'=>true),
			array('purchase_details_price, purchase_details_discount, purchase_details_quantity', 'numerical'),
			array('purchase_details_remarks', 'length', 'max'=>500),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('purchase_details_id, purchase_id, product_id, wharehouse_id, purchase_details_price, purchase_details_discount, purchase_details_quantity, purchase_details_remarks', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'purchase_details_discount' => 'Purchase Details Discount',
	...
	public function search()
	{
		...
		$criteria->compare('purchase_details_discount',$this->purchase_details_discount);
	 ...
	 * @return TblPurchaseDetails the static model class
	 */

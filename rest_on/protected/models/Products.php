...
class Products extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'product_barCode' => 'Codigo de Barras',
			'category_id' => 'Categoria',
			'product_iva' => 'Iva',
			'product_price' => 'Precio',
			'unit_id' => 'Unidad Base',
			'product_min_stock' => 'Min Stock',
			'product_max_stock' => 'Max Stock',
			'product_inventory_max_days' => 'Dias en Inventario',
			'product_image' => 'Imagen',
			'product_iscomponent' => 'Componente',
			'product_enable' => 'Habilitado',

...
class Referrals extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('referral_remarks, payment', 'length', 'max'=>500),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('referral_id, referral_consecut, company_id, request_id, customer_nit, user_id, referral_date, referral_total, referral_net_worth, accounts_id, referral_remarks, referral_status, payment', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'referral_net_worth' => 'Valor Neto',
			'accounts_id' => 'Cuenta Contable',
			'referral_remarks' => 'Observaciones',

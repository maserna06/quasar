 ...
 */
class TblInventories extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'inventory_document_number' => 'Inventory Document Number',
			'inventory_amounts' => 'Inventory Amounts',
	 ...
	 * @return TblInventories the static model class
	 */

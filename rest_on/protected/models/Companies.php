...
class Companies extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('company_id', 'unique'),
			array('company_status, deparment_id, city_id', 'numerical', 'integerOnly'=>true),
			array('company_id', 'numerical', 'integerOnly'=>true,'message'=>'Ingrese NIT sin digito de verificacion o guion medio ( - ).'),
			array('company_id, company_phone', 'length', 'max'=>20),
			array('company_url', 'length', 'max'=>500),
	...
	public function attributeLabels()
	{
		return array(
			'company_id' => 'Nit',
			'company_name' => 'Razòn Social',
			'company_phone' => 'Telefono',
			'company_address' => 'Direcciòn',
			'company_logo' => 'Logo',
			'company_url' => 'Url',
			'company_status' => 'Estado',
			'deparment_id' => 'Deparmento',
			'city_id' => 'Ciudad',
		);
	}
